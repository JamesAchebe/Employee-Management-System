 ...
 // This class creates the create account page 
 	...
 	static class CreateAccountForm extends JFrame implements ActionListener
 	{
 	    ...
 	    public void actionPerformed(ActionEvent ae)     //pass action listener as a parameter
 	    {
 	        if (ae.getSource() == sub) {
 		        ...
 		        //checks desired username for any existing matches
 		        try {
 		        	// connects to the database
 					Connection connect = EmployeeData.ConnectDB();
 					...
 					// checks every record for the right information
 					while (rs.next()) {
 						userN = rs.getString("username");
 					...
 					if (!usernameExists) {
 				        ...
 				        try {
 				        	// connects to the database
 							connect = EmployeeData.ConnectDB();
 							query = "SELECT EmpID, Firstname, Lastname, username, passw\r\n"
 									+ "FROM employee\r\n"
 							...
 							while (rs.next()) {
 								...
 								//userValue, passValue, conValue, idValue, fnValue, lnValue
	...
	private void initialize() {
       ...
       JButton btnTasks = new JButton("Tasks");
					...
					taskScroll.setViewportView(tasksTable);
					 ...
					 editTasks.addActionListener(new ActionListener() {
						 public void actionPerformed(ActionEvent e) {
							 ...
							 try {
								 // Input Edit Tasks implementation code here
							 }
							 catch(Exception ev)
							 {
								 System.err.format(ev.getMessage());
					 ...
					 createTasks.addActionListener(new ActionListener() {
						 public void actionPerformed(ActionEvent e) {
							 ...
							 try {
								 // Input Create Tasks implementation code here
							 }
							 catch(Exception ev)
							 {
								 System.err.format(ev.getMessage());
					...
					// Delete Tasks Button
					 ...
					 deleteTasks.addActionListener(new ActionListener() {
						 public void actionPerformed(ActionEvent e) {
							 ...
							 try {
								 // Input Delete Tasks implementation code here
							 }
							 catch(Exception ev)
							 {
								 System.err.format(ev.getMessage());
		 ...
		 btnTasks.setBounds(20, 660, 214, 47);
		 ...
		 JButton btnRequests = new JButton("Requests");
			btnRequests.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							conn = EmployeeData.ConnectDB();
							JFrame reqFrame = new JFrame("Requests");
							reqFrame.setVisible(true);
							reqFrame.setSize(800,800);
							reqFrame.getContentPane().setLayout(null);
							
							
							Object col[] = {"ReqID", "EmpID", "ReqName"};
							reqModel.setColumnIdentifiers(col);
								// loads current contents of the database
							...
							reqScroll.setBounds(531, 53, 819, 639);
							reqFrame.getContentPane().add(reqScroll);
							...
							reqTable.setModel(new DefaultTableModel(
								...
								reqTable.setFont(new Font("Tahoma", Font.BOLD, 14));
								reqScroll.setViewportView(reqTable);
							 
							 
							 
							 // Edit Requests Button
							 JButton editRequests = new JButton("Edit Requests");
							 editRequests.addActionListener(new ActionListener() {
								 public void actionPerformed(ActionEvent e) {
									 
									 try {
										 // Input Edit Requests implementation code here
									 }
									 catch(Exception ev)
									 {
										 System.err.format(ev.getMessage());
							 ...
							 editRequests.setFont(new Font("Tahoma", Font.BOLD, 18));
							 editRequests.setBounds(50, 50, 250, 100);
							 reqFrame.getContentPane().add(editRequests);
							 
							 
							// Create Requests Button
							 JButton createRequests = new JButton("Create Requests");
							 createRequests.addActionListener(new ActionListener() {
								 public void actionPerformed(ActionEvent e) {
									 
									 try {
										 // Input Create Requests implementation code here
									 }
									 catch(Exception ev)
									 {
										 System.err.format(ev.getMessage());
							 ...
							 createRequests.setFont(new Font("Tahoma", Font.BOLD, 18));
							 createRequests.setBounds(50, 160, 250, 100);
							 reqFrame.getContentPane().add(createRequests);
							 
							 
							 
							// Delete Requests Button
							 JButton deleteRequests = new JButton("Delete Requests");
							 deleteRequests.addActionListener(new ActionListener() {
								 public void actionPerformed(ActionEvent e) {
							 ...
							 deleteRequests.setFont(new Font("Tahoma", Font.BOLD, 18));
							 deleteRequests.setBounds(50, 270, 250, 100);
							 reqFrame.getContentPane().add(deleteRequests);		
			...
			btnRequests.setBounds(272, 660, 214, 47);
